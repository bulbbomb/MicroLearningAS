...
import com.example.microlearning.proxy.LoginRequest;
...
//		bindPreferenceSummaryToValue(findPreference("example_list"));
    ...
    private static Preference.OnPreferenceClickListener mPreferenceClickListener = new Preference.OnPreferenceClickListener() {
        ...
        public boolean onPreferenceClick(Preference preference) {
            // Examine validity of the key value
            if (preference == null || TextUtils.isEmpty(preference.getKey())) {
                Log.e("onPreferenceClick", "invalid preference");
                return false;
            }
...
//			bindPreferenceSummaryToValue(findPreference("sync_frequency"));
	...
	// TODO add 'about' fragment for large-screen device
}
